...
export function BiSolidGraduation (props) {
  return GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M2 7v1l11 4 9-4V7L11 4z"},"child":[]},{"tag":"path","attr":{"d":"M4 11v4.267c0 1.621 4.001 3.893 9 3.734 4-.126 6.586-1.972 7-3.467.024-.089.03